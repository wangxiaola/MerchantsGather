...
@interface ProgressGradientView ()<CAAnimationDelegate>
{
    CGRect innerRect;
}
@end
...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        //添加玻璃质感
        {
            ...
            layeco.colors = @[(__bridge id)glossStart,
                                     (__bridge id)glossEnd];
...
- (void) setGradientLocations:(CGFloat) leftEdge {
    ...
    CAGradientLayer *layer = (CAGradientLayer *)[[self.layer sublayers] objectAtIndex:0];
    [CATransaction begin];
