...
- (void)addAutoLayout {
    ...
    [self.line2 mas_makeConstraints:^(MASConstraintMaker *make) {
        make.bottom.mas_equalTo(-_SCREEN_WIDTH/3.0-padding);
        make.leading.mas_equalTo(0);
        make.trailing.mas_equalTo(0);
        make.height.mas_equalTo(padding);
    }];
    [self.line22 mas_makeConstraints:^(MASConstraintMaker *make) {
        make.bottom.mas_equalTo(-_SCREEN_WIDTH/3.0+padding);
        make.leading.mas_equalTo(0);
        make.trailing.mas_equalTo(0);
        make.height.mas_equalTo(padding);
    ...
    [self.line1 mas_makeConstraints:^(MASConstraintMaker *make) {
        make.bottom.mas_equalTo(weakSelf.line2.mas_top).with.offset(-_SCREEN_WIDTH/3.0-padding);
        make.leading.mas_equalTo(0);
        make.trailing.mas_equalTo(0);
        make.height.mas_equalTo(padding);
    }];
    [self.line11 mas_makeConstraints:^(MASConstraintMaker *make) {
        make.bottom.mas_equalTo(weakSelf.line2.mas_top).with.offset(-_SCREEN_WIDTH/3.0+padding);
        make.leading.mas_equalTo(0);
        make.trailing.mas_equalTo(0);
        make.height.mas_equalTo(padding);
    ...
    [self.line3 mas_makeConstraints:^(MASConstraintMaker *make) {
        ...
        make.leading.mas_equalTo(_SCREEN_WIDTH/3.0-padding);
        make.bottom.mas_equalTo(0);
        make.width.mas_equalTo(padding);
    }];
    [self.line33 mas_makeConstraints:^(MASConstraintMaker *make) {
        make.top.mas_equalTo(0);
        make.leading.mas_equalTo(_SCREEN_WIDTH/3.0+padding);
        make.bottom.mas_equalTo(0);
        make.width.mas_equalTo(padding);
    ...
    [self.line4 mas_makeConstraints:^(MASConstraintMaker *make) {
        make.top.mas_equalTo(0);
        make.trailing.mas_equalTo(-_SCREEN_WIDTH/3.0-padding);
        make.bottom.mas_equalTo(0);
        make.width.mas_equalTo(padding);
    }];
    [self.line44 mas_makeConstraints:^(MASConstraintMaker *make) {
        make.top.mas_equalTo(0);
        make.trailing.mas_equalTo(-_SCREEN_WIDTH/3.0+padding);
        make.bottom.mas_equalTo(0);
        make.width.mas_equalTo(padding);
