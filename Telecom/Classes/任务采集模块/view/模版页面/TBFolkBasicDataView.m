...
@interface TBFolkBasicDataView ()<UITableViewDelegate,UITableViewDataSource,TBRegionChooseViewDelegate,ZKLocationDelegate>
...
@end
@implementation TBFolkBasicDataView
...
- (instancetype)init
{
    ...
    if (self)
    {
        ...
        self.lefNameArray = @[@"客栈名称",@"商家类型",@"所属区域",@"GPS地址",@"详细地址",@"联系电话",@"绑定手机号"];
        self.ritNameArray = @[@"商家名称",@"请选择商家类型",@"请选择所属区域地址",@"请定位您的GPS地址",@"请输入商家详细地址",@"对外展示的电话",@"请输入店铺老板手机号"];
