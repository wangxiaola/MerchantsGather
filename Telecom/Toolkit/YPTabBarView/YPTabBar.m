...
- (void)awakeFromNib {
    ...
    _itemSelectedBgImageView.layer.borderWidth = 0.5;
    _itemSelectedBgImageView.layer.borderColor = BODER_COLOR.CGColor;
...
- (void)updateItemsFrame {
    ...
    if (self.scrollView) {
        ...
        for (NSUInteger index = 0; index < self.items.count; index++) {
            ...
            item.layer.borderColor = BODER_COLOR.CGColor;
            item.layer.cornerRadius = self.itemSelectedBgCornerRadius;
