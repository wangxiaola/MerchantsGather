...
@property (nonatomic, strong) NSArray *originalData;// 原来的数组
@property (nonatomic,strong) NSMutableArray *selectedTags;
@property (nonatomic,copy) void (^completion)(NSArray *selectTags,NSInteger currentIndex);//选中的标签数组,当前点击的index
@property (nonatomic, assign) NSInteger selectMax;//最大选择数量
@property (nonatomic,copy) void (^completionOriginal)(NSArray *originalArray);//
@property (nonatomic, copy) void (^selectMaxNumber)(void);
@property (nonatomic, strong) NSMutableArray *originalTags;
//刷新界面
- (void)reloadData;
