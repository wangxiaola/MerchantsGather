...
static const CGFloat kHeightFromBottom = 120.f;
    ...
    if(notifierView) {
        ...
        [self updateNotifierWithAnimation:notifierView withText:text completion:^(BOOL finished) {
            ...
            if(!shouldDismiss) {
                ...
                [separatorImageView setBackgroundColor:[UIColor clearColor]];
        ...
        notifierView.backgroundColor = [UIColor colorWithWhite:0 alpha:0.5];
